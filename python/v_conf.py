X_BASE = 2000#1800 #1500 #3000 #3000 # 4000 #1400 # distance between drives (width) [mm]
Y_BASE = 2000#2000 #1400 # distance between drives and ground (height) [mm], only limitation, all parameters are calculated from X_BASE
