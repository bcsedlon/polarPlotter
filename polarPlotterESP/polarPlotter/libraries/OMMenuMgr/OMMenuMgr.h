...
#ifndef OM_MENU_ROWS
    #define OM_MENU_ROWS    6
#endif

#ifndef OM_MENU_COLS1
    #define OM_MENU_COLS    40
#endif
...
*/
#define MENU_ITEM           const OMMenuItem   //added the const for progmem
#define MENU_LIST           const OMMenuItem*
#define MENU_VALUE          const OMMenuValue
#define MENU_FLAG           const OMMenuValueFlag
#define MENU_SELECT_ITEM    const OMMenuSelectListItem
#define MENU_SELECT_LIST    const OMMenuSelectListItem*
#define MENU_SELECT         const OMMenuSelectValue
#define MENU_SELECT_SIZE(x) sizeof(x) / sizeof(OMMenuSelectListItem*)
#define MENU_SIZE(x)        sizeof(x) / sizeof(OMMenuItem*)
//add line to make it work with new gcc
//#define MENU_TARGET(x)      reinterpret_cast<void*>(x)
